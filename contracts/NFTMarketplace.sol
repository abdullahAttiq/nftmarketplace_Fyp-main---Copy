...
contract NFTMarketplace is ERC721URIStorage {
    ...
    function createMarketItem(uint256 tokenId, uint256 price, uint256 _royaltyPercentage) private {
    ...
    function createMarketSale(uint256 tokenId) public payable {
        ...
        payable(idToMarketItem[tokenId].orignalOwner).transfer(royaltyAmount);
